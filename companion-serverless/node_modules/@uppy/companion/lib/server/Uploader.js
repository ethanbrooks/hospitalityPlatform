...
class Uploader {
    ...
    emitIllusiveProgress(bytesUploaded) {
        ...
        logger.debug(`${this.shortToken} ${bytesUploaded} ${illusiveBytesUploaded} ${bytesTotal}`, 'uploader.illusive.progress');
    ...
    emitProgress(bytesUploaded, bytesTotal) {
        ...
        logger.debug(`${this.shortToken} ${bytesUploaded} ${bytesTotal} ${formatPercentage}%`, 'uploader.upload.progress');
        const dataToEmit = {
            action: 'progress',
    ...
    uploadMultipart() {
        ...
        const formData = Object.assign({}, this.options.metadata, { [this.options.fieldname]: file });
